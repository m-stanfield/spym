...
Original file is located at
    https://colab.research.google.com/drive/1iR_irtamsSiFVdJmkM2a8V100dwD48S-
# Spym Main Module
** Version 0.1.1**
** Last Modified: 2018/11/27 **
** Written by Matthew Stanfield **
Change Log Found [Here](https://docs.google.com/document/d/1MngNoEhOlmDOAbK7DvZGeRumD_BTyavB2XpaPxpyReU/edit)
In this module all of the base  functions for modeling Self Phase Modulation.
** Current Models: **
*   Analytic Solutions assuming Zero Dispersion
*   Full 1D Solver from PyNLO
** Spectrum Generatiing Methods: **
*    Gaussian Spectrum
** Phase Generating Methods **
*    GDD, TOD, FOD in PyNLO
"""
